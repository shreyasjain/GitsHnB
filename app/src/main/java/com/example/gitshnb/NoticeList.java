...
public class NoticeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noticesListView = (ListView)findViewById(R.id.noticeListview);
        dataRet();
    ...
    public void dataRet()
    {
        ...
        DatabaseReference refComplaint = database.getReference().child("NOTICE").child("HOSTEL");
        ...
        new CountDownTimer(8000,1000)
        {
            ...
            public void onFinish() {
                ...
                noticesListView.setAdapter(customAdapter);
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = getLayoutInflater().inflate(R.layout.my_list_notices,null);
